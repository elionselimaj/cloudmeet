...
class RNConnectionService extends ReactContextBaseJavaModule {
    ...
    private RNConnectionService.CallAudioStateListener callAudioStateListener;
    ...
    public void startCall(String callUUID, String handle, boolean hasVideo, Promise promise) {
        JitsiMeetLogger.d("%s startCall UUID=%s, h=%s, v=%s", new Object[]{"JitsiConnectionService", callUUID, handle, hasVideo});
        ...
        try {
            ...
            JitsiMeetLogger.e(var13, "JitsiConnectionService error in startCall", new Object[0]);
        ...
        try {
            ...
            JitsiMeetLogger.e(var14, "JitsiConnectionService error in startCall", new Object[0]);
            if (tm != null) {
                try {
    ...
    public RNConnectionService.CallAudioStateListener getCallAudioStateListener() {
        return this.callAudioStateListener;
    }

    public void setCallAudioStateListener(RNConnectionService.CallAudioStateListener callAudioStateListener) {
